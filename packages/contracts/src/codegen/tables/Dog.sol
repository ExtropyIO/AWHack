...
library Dog {
  ...
  function lengthColor(IStore _store, bytes32 key) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function getItemColor(IStore _store, bytes32 key, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function popColor(IStore _store, bytes32 key) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function updateColor(IStore _store, bytes32 key, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  /** Get the full data */
  function get(bytes32 key) internal view returns (DogData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function get(IStore _store, bytes32 key) internal view returns (DogData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32((key));
  ...
  function set(bytes32 key, address owner, string memory name, string memory color) internal {
  ...
  function set(IStore _store, bytes32 key, address owner, string memory name, string memory color) internal {
    bytes memory _data = encode(owner, name, color);
  ...
  function set(bytes32 key, DogData memory _table) internal {
    set(key, _table.owner, _table.name, _table.color);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, DogData memory _table) internal {
    set(_store, key, _table.owner, _table.name, _table.color);
  }
